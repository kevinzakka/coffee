...
# class ArmConfig:
#     """PyBullet robot arm configuration."""
...
#     arm_pose: Pose = Pose()
#     """Pose of the manipulator in the world frame."""

#     joint_resting_configuration: Optional[hints.Array] = None
#     """The configuration of the joints at rest. Useful for biasing the inverse
...
#     """Maximum time to wait for a joint to reach a desired state. This value should be
#     tuned if movement speed is changed."""


# @dataclasses.dataclass(frozen=False)
# class Arm:
#     """A robotic arm in PyBullet."""
...
#             arm_config.urdf,
#             pose=arm_config.arm_pose,
#             useFixedBase=arm_config.fixed_base,
#             flags=flags,
#         )
...
#             body_id,
#             pb_client,
#             arm_config.joint_resting_configuration,
#         )

#         if arm_config.ik_point_link_name is None:
#             ik_point_joint_id = joints.controllable_joints[-1]
#         else:
#             ik_point_joint_id = joints.get_joint_index_from_link_name(
#                 arm_config.ik_point_link_name
#             )
...
#         """
#         if self.arm_config.joint_resting_configuration is not None:
#             q_home = self.arm_config.joint_resting_configuration
#         else:
...
#             epsilon = self.arm_config.max_joint_position_error

#             start_time = time.time()
#             while True:
#                 if time.time() - start_time > self.arm_config.movement_timeout:
...
#             epsilon = self.arm_config.max_joint_velocity_error
